...
public static class HostBuilderConfigureServicesExtensions
{
    public static IHostBuilder AddServices(this IHostBuilder hostBuilder)
    {
        hostBuilder.ConfigureServices((_, services) =>
        {
            ...
            // Add PageTransitions:
            services.AddTransient(_ => new CrossFade(new TimeSpan(400)));
            services.AddTransient(_ => new SlideLeftPageTransition(new TimeSpan(400)));
            services.AddTransient(_ => new SlideRightPageTransition(new TimeSpan(400)));
